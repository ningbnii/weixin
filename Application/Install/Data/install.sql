...
--
-- 表的结构 `onethink_areply`
--

CREATE TABLE IF NOT EXISTS `onethink_areply` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='模型属性表' AUTO_INCREMENT=37 ;
...
(36, 'case', '案例图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '案例图片', 1, '', 14, 0, 1, 1420773534, 1420773534, '', 3, '', 'regex', '', 3, 'function');
...
--
-- 表的结构 `onethink_catemenu`
--

CREATE TABLE IF NOT EXISTS `onethink_catemenu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
  `picurl` varchar(100) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `sort` varchar(100) NOT NULL DEFAULT '0',
...
--
-- 表的结构 `onethink_classify`
--

CREATE TABLE IF NOT EXISTS `onethink_classify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fid` int(11) NOT NULL,
  `name` varchar(60) NOT NULL,
  `info` varchar(90) NOT NULL COMMENT '分类描述',
  `sorts` varchar(6) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  ...
  `list` varchar(10) NOT NULL DEFAULT '0',
  `content` varchar(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
(1, 'WEB_SITE_TITLE', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1379235274, 1, '微信部落-开源第三方微信公众平台|微信订制开发', 0),
(2, 'WEB_SITE_DESCRIPTION', 2, '网站描述', 1, '', '网站搜索引擎描述', 1378898976, 1379235841, 1, '微信部落是一个开源第三方微信公众平台，提供基于微信部落的微信订制开发', 1),
(3, 'WEB_SITE_KEYWORD', 2, '网站关键字', 1, '', '网站搜索引擎关键字', 1378898976, 1381390100, 1, '微信部落,开源第三方微信公众平台,微信订制开发', 8),
...
(38, 'SITE_TOKEN', 1, '授权码', 1, '', '授权码', 1428816163, 1428816702, 1, '', 0),
(39, 'SITE_URL', 1, '网站域名', 1, '', '网站域名', 1428816357, 1428816357, 1, '', 0);
-- --------------------------------------------------------

--
-- 表的结构 `onethink_diymen`
--

CREATE TABLE IF NOT EXISTS `onethink_diymen` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `fid` int(11) NOT NULL,
...
--
-- 表的结构 `onethink_document_functions_show`
--

CREATE TABLE IF NOT EXISTS `onethink_document_functions_show` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `case` int(10) unsigned NOT NULL COMMENT '案例图片',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `onethink_flash` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `img` char(255) NOT NULL,
  `url` char(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `onethink_home` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `title` varchar(30) NOT NULL,
  ...
  `play_img` varchar(10) NOT NULL,
  `play_audio` varchar(10) NOT NULL,
  `createtime` varchar(13) NOT NULL,
  `updatetime` varchar(13) NOT NULL,
  `plugmenu_color` varchar(8) NOT NULL,
  `catemenuid` varchar(4) NOT NULL DEFAULT '0',
  `tpid` varchar(10) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `onethink_img` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
--
-- 表的结构 `onethink_keyword`
--

CREATE TABLE IF NOT EXISTS `onethink_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyword` char(255) NOT NULL,
  `pid` int(11) NOT NULL,
  `token` varchar(30) NOT NULL,
...
--
-- 表的结构 `onethink_magzine`
--

CREATE TABLE IF NOT EXISTS `onethink_magzine` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  ...
  `copyrighturl` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `onethink_media` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
...
(14, 'functions_show', '功能展示', 1, '', 1, '{"1":["3","12","36"]}', '1:基础', '12,3,36', '', '', '', '', '', 10, '', '', 1420773483, 1420774069, 1, 'MyISAM');
...
CREATE TABLE IF NOT EXISTS `onethink_music` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `onethink_other` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `keyword` varchar(60) NOT NULL,
  `createtime` varchar(13) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `onethink_photo` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `keyword` varchar(30) NOT NULL,
  `title` varchar(30) NOT NULL,
  ...
  `createtime` varchar(13) NOT NULL,
  `updatetime` varchar(13) NOT NULL,
  `bgpic` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;


--
-- 表的结构 `onethink_photo_items`
--

CREATE TABLE IF NOT EXISTS `onethink_photo_items` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `onethink_reply` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `keyword` varchar(30) NOT NULL,
  `title` varchar(30) NOT NULL,
...
--
-- 表的结构 `onethink_reply_data`
--

CREATE TABLE IF NOT EXISTS `onethink_reply_data` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `onethink_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `keyword` varchar(30) NOT NULL,
  `title` varchar(30) NOT NULL,
...
--
-- 表的结构 `onethink_shop_classify`
--

CREATE TABLE IF NOT EXISTS `onethink_shop_classify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fid` int(11) NOT NULL,
  `name` varchar(60) NOT NULL,
  `info` varchar(90) NOT NULL COMMENT '分类描述',
...
--
-- 表的结构 `onethink_shop_flash`
--

CREATE TABLE IF NOT EXISTS `onethink_shop_flash` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `img` char(255) NOT NULL,
  `url` char(255) NOT NULL,
...
--
-- 表的结构 `onethink_shop_products`
--

CREATE TABLE IF NOT EXISTS `onethink_shop_products` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `postage` int(4) unsigned NOT NULL,
  `pic` varchar(255) NOT NULL,
  `info` text NOT NULL,
  `createtime` varchar(13) NOT NULL,
  `updatetime` varchar(13) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `onethink_silk` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `keyword` varchar(30) NOT NULL,
  `title` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `onethink_text` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `keyword` char(255) NOT NULL,
  `text` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `onethink_vote` (
  ...
  `pic` varchar(200) NOT NULL,
  `createtime` varchar(13) NOT NULL,
  `starttime` varchar(13) NOT NULL,
  `endtime` varchar(13) NOT NULL,
  `regflag` tinyint(2) NOT NULL DEFAULT '1',
...
--
-- 表的结构 `onethink_vote_item`
--

CREATE TABLE IF NOT EXISTS `onethink_vote_item` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `pid` int(11) unsigned NOT NULL,
...
--
-- 表的结构 `onethink_vote_question`
--

CREATE TABLE IF NOT EXISTS `onethink_vote_question` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `pid` int(11) unsigned NOT NULL,
  `title` varchar(30) NOT NULL,
...
--
-- 表的结构 `onethink_vote_record`
--

CREATE TABLE IF NOT EXISTS `onethink_vote_record` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `wecha_id` varchar(30) NOT NULL,
  `pid` int(11) unsigned NOT NULL,
...
--
-- 表的结构 `onethink_vote_user`
--

CREATE TABLE IF NOT EXISTS `onethink_vote_user` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `onethink_wecha` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `wecha_id` varchar(30) NOT NULL,
  `createtime` varchar(13) NOT NULL,
...
--
-- 表的结构 `onethink_wecha_user`
--

CREATE TABLE IF NOT EXISTS `onethink_wecha_user` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `wecha_id` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
...
-- 表的结构 `onethink_wxuser`
--

CREATE TABLE IF NOT EXISTS `onethink_wxuser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  ...
  `createtime` varchar(13) NOT NULL,
  `updatetime` varchar(13) NOT NULL,
  `encodingaeskey` varchar(43) NOT NULL DEFAULT '',
  `access_token` varchar(512) NOT NULL,
  `access_token_createtime` varchar(13) NOT NULL,
  `qrcode` varchar(255) NOT NULL,
  `is_qrcode` tinyint(1) NOT NULL DEFAULT '2',
  `qrcode_url` varchar(200) NOT NULL,
  `ticket` varchar(200) NOT NULL,
  `ticket_createtime` varchar(13) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`) USING BTREE
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
