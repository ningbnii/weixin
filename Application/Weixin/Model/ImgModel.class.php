...
class ImgModel extends Model{
	...
	protected $_validate = array(
		...
		array('classid','require','图文类别',self::VALUE_VALIDATE,'regex',self::MODEL_BOTH),
		array('showpic','require','图文类别',self::VALUE_VALIDATE,'regex',self::MODEL_BOTH),
		array('info','require','详情',self::VALUE_VALIDATE,'regex',self::MODEL_BOTH),
		);
	/**
	 * 自动完成规则
	 */
